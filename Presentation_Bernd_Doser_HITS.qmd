...
- Experiments defined in yaml file(s)
...
![](images/HiPSter.drawio.svg){width="900"}


## Summary and Outlook

- First Prototyp public available (space.h-its.org)
- Evaluate Encoder, Decoder, Loss function
- Machine learning workflow
- Learning of point clouds instead of images
